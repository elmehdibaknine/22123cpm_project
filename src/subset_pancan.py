...
def main():
    ...
    # Init paths
    counts_path = "data/raw/tcga_expected_count.gz"
    tpm_path = "data/raw/tcga_rsem_isoform_tpm.gz"
    counts_outpath = "data/processed/tcga_counts_subset.tsv"
    tpm_outpath = "data/processed/tgca_tpm_subset.tsv"
